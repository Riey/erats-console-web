...
function consoleLineAlignmentToClassName(align) {
    switch (align) {
        case erats_1.ConsoleLineAlignment.Left: return "era-line-left";
        case erats_1.ConsoleLineAlignment.Center: return "era-line-center";
        case erats_1.ConsoleLineAlignment.Right: return "era-line-right";
    }
}
class EraWebConsole {
    constructor(parent, inputElem, onSetColor, onSetBgColor, onSetHlColor) {
        this.alignment = erats_1.ConsoleLineAlignment.Left;
        this.parent = parent;
    ...
    sendInputByInputElem(route) {
        ...
        switch (this._inputReq.type) {
            case erats_1.InputRequestType.AnyKey:
            case erats_1.InputRequestType.EnterKey: {
                this.onEnterResponse(route, null);
                break;
            }
            case erats_1.InputRequestType.Int: {
                this.onEnterResponse(route, this._inputElem.valueAsNumber);
                break;
            }
            case erats_1.InputRequestType.Str: {
